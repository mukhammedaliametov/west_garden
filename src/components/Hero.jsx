...
const Hero = () => {
  return (
    <div className="container text-center font-montserrat relative">
        ...
        <div className="hidden md:block w-[193px] p-[10px] bg-white absolute top-[230px] right-[40px] rounded-[5px]">
